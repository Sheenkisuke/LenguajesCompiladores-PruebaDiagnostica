...
FEN significa Forsyth-Edwards Notation. Es un estándar usado en ajedrez para representar una posición completa en una sola línea de texto.

Por ejemplo, esta es la posición inicial del ajedrez: rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1
...
1	"Posición de las piezas: 8 filas separadas por /. Cada fila suma 8.
     Las letras minúsculas son piezas negras, mayúsculas son blancas.
     Los números son casillas vacías."
...
5	"Contador de medios movimientos: número ≥ 0, para la regla de los 50 movimientos."
6	"Número de movimiento completo: empieza en 1 y aumenta después de cada movimiento de negras."
*/
